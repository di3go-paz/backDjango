...
INSTALLED_APPS = [
    ...
    'rest_framework', #biblioteca de django que facilita la creacion de apis.1.
    'corsheaders', #un paquete que permite gestionar los encabezados CORS en la plicacion django.2.
    'apps.inventory', #modulo para gestion de inventario como salidas entradas y ajustes.
...
STATIC_URL = '/static/'
STATIC_ROOT = "/home/di3gopaz/erp/backDjango/staticfiles"
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'
# Default primary key field type
# https://docs.djangoproject.com/en/5.2/ref/settings/#default-auto-field

MEDIA_URL = "/media/"
MEDIA_ROOT = "/home/di3gopaz/erp/backDjango/media"

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

AUTH_USER_MODEL = 'users.CustomUser'

# Archivos estáticos para producción (Render)
STATIC_URL = '/static/'
